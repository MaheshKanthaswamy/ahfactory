...
(function ($) {
    $("body").on("click", "a[data-popup]", function (e) {
        ...
        var fwidth = $this.attr("data-popup-force-width");
        var fheight = $this.attr("data-popup-force-height");
        var classes = $this.attr("data-popup-classes");
        var closeother = $this.attr("data-popup-close-other");

        var closebutton = $this.attr("data-popup-close-button");
        var onclose = $this.attr("data-popup-onclose");
        ...
        $.ajax(url).done(function (resp) {
            ...
            $modal.addClass("data-popup-reveal");
